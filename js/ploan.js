...
$(document).ready(function() {
    ...
    if (CALC_NAME === 'Іпотекою') { $('#borrow .inline-result').append('<br/><span style="font-weight:normal;font-size:1em;color:#333333"><strong>Порада:</strong> Це максимальний рівень, але <strong>плануйте наперед</strong> з урахуванням зростання відсотків (використовуйте сценарій нижче)</span>'); }
...
function DrawCalculator() { // CALCULATOR HTML
    ...
    html = '<h2>Скільки сплатите за ' + CALC_NAME.toLowerCase() + ' ?</h2>' +
        // html = '<h2>Скільки сплачу за іпотекою?</h2>' +
        '<div class="flex input">' +
        '<p class="label-required">обов\'язкове поле</p>' +
        '<h3 class="col100">Деталі за ' + CALC_NAME.toLowerCase() + '</h3>' +
        '<p><label for="repay-amount1">Сума заборгованості:</label><input type="text" inputmode="numeric" id="repay-amount1" class="dollars int empty"/></p>' +
        ...
        '<p><label for="repay-freq1">Періодичність сплати:</label><select class="frequency-select" id="repay-freq1"/></p>' +
        '<p><label for="repay-length1">Термін кредиту:</label><input type="text" inputmode="numeric" id="repay-length1" value="25 років" class="years int"/></p>' +
        '<p><label for="repay-fee1">Комісії:</label><input type="text" inputmode="numeric" id="repay-fee1" value="₴100" class="dollars int"/></p>' +
        ...
        '<h3 class="col100">Всього до сплати <button class="tooltip"><span class="tooltiptext">Загальна сума, яку ви заплатите позикодавцю протягом усього терміну дії позики.</span></button></h3>' +
        '<div class="chart result-box col100"/>';
    // How much will my repayments be? Explore
    html = html + '<p class="inline-result col100">Ваші виплати складуть: <span class="enlarge-text"></span></p>' +
        ...
        '<p><label for="repay-amount1-explore">Сума заборгованості:</label><input type="text" inputmode="numeric" id="repay-amount1-explore" class="small dollars int empty"/></p>' +
        '<p class="explore-select"><label for="repay-freq1-explore">Періодичність сплати:</label><select class="frequency-select" id="repay-freq1-explore"/></p>' +
        '<p><label for="repay-length1-explore">Термін кредиту:</label><input type="text" inputmode="numeric" id="repay-length1-explore" value="25 років" class="small years int"/></p>' +
        '</div></div></div></div>';
    $("#repayments").html(html);


    // How much can I borrow?
    html = '<h2>Скільки кредиту я можу собі дозволити?</h2>' +
        '<div class="flex input">' +
        '<p class="label-required">обов\'язкове поле</p>' +
        '<h3 class="col100">Деталі за ' + CALC_NAME.toLowerCase() + '</h3>' +
        '<p><label for="payment1">Можлива сума сплати:</label><input type="text" inputmode="numeric" id="payment1" class="dollars int empty"/></p>' +
        '<p><label for="freq1">Періодичність сплати:</label><select class="frequency-select" id="freq1"/></p>' +
        '<p><label for="rate1">Відсоткова ставка:</label><input type="text" inputmode="decimal" id="rate1" class="interest float empty"/> </p>' +
        '<p><label for="length1">Термін дії кредиту:</label><input type="text" inputmode="numeric" id="length1" value="25 років" class="years int"/></p>' +
        '<p><label for="fee1">Комісійні:</label><input type="text" inputmode="numeric" id="fee1" value="₴100" class="dollars int"/></p>' +
    ...
    html = html + '<p class="col100 inline-result">Ви можете дозволити собі позичити: <span class="enlarge-text"/></p>' +
        '<div class="alternative col100">' +
        ...
        '<p><label for="payment1-explore">Можлива сума сплати:</label><input type="text" inputmode="numeric" id="payment1-explore" class="small dollars int empty"/><select class="frequency-select" id="freq1-explore"/></p>' +
        '<p><label for="length1-explore">Термін дії кредиту:</label><input type="text" inputmode="numeric" id="length1-explore" value="25 років" class="small years int"/></p>' +
        '</div></div></div></div>';
    $("#borrow").html(html);


    // How can I repay my loan sooner?
    html = '<h2>Як можливо повернути позику раніше?</h2>' +
        '<div class="flex input">' +
        '<p class="label-required">обов\'язкове поле</p>' +
        '<h3 class="col100">Поточна сума боргу за ' + CALC_NAME.toLowerCase() + '</h3>' +
        '<p><label for="howlong-amount1">Сума заборгованості:</label><input type="text" inputmode="numeric" id="howlong-amount1" class="dollars int empty"/></p>' +
        '<p><label for="howlong-payment1">Виплати:</label><input type="text" inputmode="numeric" id="howlong-payment1" class="dollars int empty"/></p>' +
        '<p><label for="howlong-payment1">Періодичність виплат:</label><select class="frequency-select" id="howlong-freq1"/></p>' +
        ...
        '<p><label for="howlong-fee1">Комісійні:</label><input type="text" inputmode="numeric" id="howlong-fee1" value="₴100" class="dollars int"/></p>' +
    ...
    html = html + '<p class="col100 inline-result">Термін повернення: <span class="enlarge-text"/></p>' +
        '<div class="alternative col100">' +
        '<h4 class="col100">Розгляньте альтернативу</h4>' +
        '<div class="alternative-fields">' +
        ...
        '<p><label for="howlong-payment1-explore">Сума сплати:</label><input type="text" inputmode="numeric" id="howlong-payment1-explore" class="dollars int empty"/><select class="frequency-select" id="howlong-freq1-explore"/></p>' +
        '</div></div></div></div>';
    $("#howlong").html(html);
...
function CalculateRepayments(lastEl) {
    ...
    var label = '<span style="font-weight:bold;color:#333;font-size:1rem;">Деталі кредиту</span><br><span style="color:#333;">Виплати </span><span style="color:#333;font-weight:bold">₴' + formatNumber(pmt, 0, 0, true) + '</span><span style="color:#333;">' + freqString(per) + '</span><br/>' + rate + '% протягом ' + years + ' років';
    ...
    var label1 = '<span style="font-weight:bold;color:#333;font-size:1rem;">Альтернатива</span><br /><span style="color:#333;">Виплати </span><span style="color:#333;font-weight:bold">₴' + formatNumber(pmt1, 0, 0, true) + '</span><span style="color:#333;">' + freqString(per1) + '</span><br/>' + rate1 + '% протягом ' + years1 + ' років';
    ...
    if (repaymentsChart === undefined) { //we need to create the chart on first use
        ...
        repaymentsChart = new Highcharts.Chart({
            ...
            series: [{
                name: 'Відсотки (включно з комісійними)',
...
function CalculateBorrowAmount(lastEl) {
    ...
    if (principal <= 0) {
        interest = 0;
        principal = 0;
        $("#borrow .inline-result span:first").text("N/A");
        label = '<span style="color:#D84847">Платежі не покривають відсотків і зборів</span>';
    } else {
        $("#borrow .inline-result span:first").text('₴' + formatNumber(principal, 0, 0, true));
        label = '<span style="font-weight:bold;color:#333;font-size:1rem;">Деталі кредиту</span><br><span style="color:#333;">Запозичення </span><span style="color:#333;font-weight:bold;">₴' + formatNumber(principal, 0, 0, true) + '</span><br/>' + rate + '% протягом ' + years + ' років';
    }
    ...
    if (principal1 <= 0) {
        interest1 = 0;
        principal1 = 0;
        label1 = '<span style="color:#D84847">Платежі не покривають відсотків і зборів</span>';
    } else {
        label1 = '<span style="font-weight:bold;color:#333;font-size:1rem;">Альтернатива</span><br><span style="color:#333;">Запозичення </span><span style="font-weight:bold;">₴' + formatNumber(principal1, 0, 0, true) + '</span><br/>' + rate1 + '% протягом ' + years1 + ' років';
    }
...
function CalculateHowlong(lastEl) {
    ...
    } else { label = '<span style="font-weight:bold;color:#333;font-size:1rem;">Деталі кредиту</span><br><span style="font-weight:bold;">' + label + '</span><br/>₴' + formatNumber(pmt, 0, 0, true) + freqString(per) + ' під ' + rate + '%'; }
