  ...
  var SLIDES_AUTO_PLAY = true;
          ...
          document.addEventListener("DOMContentLoaded", function(e) {
             ...
             if (window.innerWidth > window.innerHeight) {
                  imageUrl = "https://files.moneysmart.gov.au/media/3sih3uwx/radar_banner-image_b_1500.jpg"
              }else {
                  imageUrl = "https://files.moneysmart.gov.au/media/z4agr2cc/radar_banner-image_b_2500.jpg"
              }
              ...
              function jumpSlide(slideIndex) {
                  ...
                  slides[slideIndex-1].parentElement.parentElement.dataset.currentSlide = slideIndex;
