$(document).ready(function() {
    ...
    $(".qquestion").each(function(i) {
        ...
        $("#q" + i + " li").each(function(x) {
            ...
            //set default values
            if (value === '') {
                if ($(this).hasClass("zavgdy")) { value = 2; } else if ($(this).hasClass("inkoly")) {
                    value = 1;
                } else { value = 0; }
            }
    ...
    $("#qresults").append('<button type="button" style="float:right" class="start-over">З початку</button>');
